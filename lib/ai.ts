    ...
    messages: [
      {
        ...
        content: [
          ...
          "- infer USD only for $, USD, dollars, bucks, 美元, 美金, 刀, or 刀乐",
          "- Chinese amounts like 五美元, 5美元, 50 美元 mean USD",
          "- informal Chinese money words 刀 and 刀乐 mean USD (e.g. 10刀, 十刀乐 = 10 USD)",
          ...
          "- if the price is a bare number without a currency marker, do not infer USD; return ok:false with reason 'Missing USD price. Please include USD, dollars, $, 美元, 美金, 刀, or 刀乐.'",
