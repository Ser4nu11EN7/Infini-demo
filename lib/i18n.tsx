...
export const messages = {
  en: {
    nav: {
      ...
      productMenu: {
        ...
        payroll: "Payroll & Bill Pay",
        treasury: "Treasury Management",
        wallet: "Infini Wallet",
      },
      productMenuDescriptions: {
        globalAccounts: "Multi-currency business accounts",
        corporateCards: "Cards for online teams",
        paymentGateway: "Collect and send stablecoin payments",
        payroll: "Automate recurring payouts",
        treasury: "Manage balances and yield",
        wallet: "A wallet for business finance",
      },
      resourceMenu: {
      ...
      resourceMenuDescriptions: {
        documentation: "Developer guides and API basics",
        apiReference: "Build on Infini's payment rails",
        blog: "Product updates and company notes",
        contactSales: "Talk to the Infini team",
      },
    },
    home: {
  ...
  zh: {
    nav: {
      ...
      productMenuDescriptions: {
        globalAccounts: "多币种企业账户",
        corporateCards: "线上团队卡片支出",
        paymentGateway: "收取和发送稳定币付款",
        payroll: "自动化周期性付款",
        treasury: "管理余额和收益",
        wallet: "面向企业财务的钱包",
      },
      ...
      resourceMenuDescriptions: {
        documentation: "开发指南和 API 基础",
        apiReference: "接入 Infini 支付能力",
        blog: "产品更新和公司动态",
        contactSales: "联系 Infini 团队",
      },
    },
    home: {
